...
function BaseEntity:isSensor()
    if not self.fixture then return end
    return self.fixture:isSensor()
end

function BaseEntity:setGravityScale(gravity)
    if not self.body then return end
    self.body:setGravityScale(gravity)
end

function BaseEntity:getGravityScale()
    if not self.body then return end
    return self.body:getGravityScale()
end

function BaseEntity:setLinearDamping(damping)
    self.body:setLinearDamping(damping)
end

function BaseEntity:setMass(mass)
